...
const bosh = [
  ...
  '自古以来, x都是人民群众喜闻乐见的. ',
  '可以预见, 在未来的很长一段时间, x都将存在下去. ',
  '毋庸置疑, 忽视和逃避x的人都将被钉在历史的耻辱柱上. ',
];
...
const meeting = [
  '今天, 我们要解决x的问题. 首先, 我们要统一思想, 统一步骤地, 为了根本解决x的问题而努力. ',
  '我们想, 在原始共产社会, 那个时候, 人们是不会思考x的, 更谈不到有什么x. 在那个时候呢, 也发生不了当前的, 现实生活中所存在的x的问题. ',
  '我希望大家本着知无不言、言无不尽、言者无罪、闻者足戒的精神, 对x进行讨论. ',
];
